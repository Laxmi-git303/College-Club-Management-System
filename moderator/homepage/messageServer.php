...
include '../../dbconnect.php';
	...
	$format = '/^[A-Z]{3}[0-9]{2}[A-Z]{2}[0-9]{3}|[0-9]{4}-[0-9]{3}-[0-9]{1}$/';
	...
	-webkit-box-shadow: 1px 6px 23px 1px rgba(112,112,112,1);
	-moz-box-shadow: 1px 6px 23px 1px rgba(112,112,112,1);
	box-shadow: 1px 6px 23px 1px rgba(112,112,112,1);'>Invalid ID format. ID looks like XXX-XX-XX-XXX or XXXX-XXX-X.</font></p>";

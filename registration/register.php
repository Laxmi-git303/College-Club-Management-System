			...
			?>
				...
				<p id="username-err"></p>
				 ...
				 <p id="dept-err"></p>
				  ...
				  <b>Semester :</b>
				  <input type="radio" name="semester" value="S1" checked>S1
				  <input type="radio" name="semester" value="S2">S2
				  <input type="radio" name="semester" value="S3">S3
				  <input type="radio" name="semester" value="S4">S4
				  <input type="radio" name="semester" value="S5">S5
				  <input type="radio" name="semester" value="S6">S6
				  <input type="radio" name="semester" value="S7">S7
				  <input type="radio" name="semester" value="S8">S8
				<br><br>
				<b>Gender : </b>
